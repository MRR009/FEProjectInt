...
export class DocumentDashboardComponent implements OnInit, AfterViewInit {
  ...
  revDateFilter = new FormControl('');
  docTitleFilter = new FormControl('');
  progCodeFilter = new FormControl('');
  countryFilter = new FormControl('');
  resTypeFilter = new FormControl('');
  dataSource = new MatTableDataSource();
  revStatusFilter = new FormControl('');
  docStatusFilter = new FormControl('');
