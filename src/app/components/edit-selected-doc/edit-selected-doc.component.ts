...
export class EditSelectedDocComponent implements OnInit {
  ...
  constructor(private fb:FormBuilder, private documentService: DocumentService,public dialogRef: MatDialogRef<ReadDocumentComponent>,@Inject(MAT_DIALOG_DATA) public data: DataExport) { }
